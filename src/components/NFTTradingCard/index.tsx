...
function Index({ data, buttonProps, infoRender, ...props }: CardProps) {
  const { age, tokenId, star, url, mintTime, price, sellTime } = data;
    ...
    >
      ...
      >
        ...
        {infoRender ? (
          ...
          <InfoItem
            title={"挂售时间"}
            value={dayjs(sellTime).format("YYYY.MM.DD")}
          />
        )}
        ...
        {buttonProps?.renderButton ? (
          ...
          <BaseButton {...defaultButtonStyle} {...buttonProps}>
